...
const hasLowPriorityCompleted = tasks.some(task => task.priority === "baixa" && task.completed === true);
console.log("Existe tarefa de baixa prioridade concluída?", hasLowPriorityCompleted);
